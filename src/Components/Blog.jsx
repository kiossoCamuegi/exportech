         ...
         <div className="wrapper">
            ...
            <div className="blog-boxes">
               <div className="v-boxes">
                  <article>
                     <div className="image">
                        <ImageLazyLoading source="https://store.exportech.com.pt/wp-content/uploads/2024/03/IMG_6147-min-2048x1365.jpg" />
                     </div>
                  ...
                  <article>
                     <div className="image">
                        <ImageLazyLoading source="https://store.exportech.com.pt/wp-content/uploads/2024/03/IMG_6174-min-2048x1365.jpg" />
                     </div>
                     <div className="step">Nova</div>
                     <h1>18 Anos a Prestar Serviços de Excelência ...</h1>
               ...
               <article className='vt-box'>
                  <div className="image">
                     <ImageLazyLoading source="https://store.exportech.com.pt/wp-content/uploads/2024/03/projects-7-big.jpg" />
                  </div>
                  <div className="text">
                     <div className="step">Nova</div>
                     <h1>18 Anos a Prestar Serviços de Excelência ...</h1>
